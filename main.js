...
d3.select("select")
  ...
  svg.selectAll("mylabels")
    ...
    .append("text")
      ...
      .append("circle")
        .attr("cx", width-margin.left +50)
        .attr("cy", function(d,i){ return 400 + i*40}) // 100 is where the first dot appears. 25 is the distance between dots
        .attr("r", 14)
    ...
    svg.selectAll("mylabels_ethnicity")
      ...
      .append("text")
        .attr("font-size","40px")
        .attr("x", width+margin.left )
        .attr("y", function(d,i){ return 400+ i*40}) // 100 is where the first dot appears. 25 is the distance between dots
        .style("fill", function(d){ return colorScale_ethnicity(d)})
        .text(function(d){ return d})
        .attr("text-anchor", "left")
        .style("alignment-baseline", "middle")
